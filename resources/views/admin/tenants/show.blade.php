        ...
        <div class="col-md-4">
            <div class="card bg-style text-center p-4">
                ...
                <ul class="list-group list-group-flush text-start mt-4 bg-transparent">
                    <li class="list-group-item bg-transparent border-secondary" style="color: black !important;"><i class="fa-solid fa-phone" style="color: black !important;"></i> @include('admin.partials.phone_links', ['phone' => $tenant->phone])</li>
            ...
            <div class="card bg-style">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-4 mb-3"><p class="mb-1 text-muted">Phone Number</p><strong>@include('admin.partials.phone_links', ['phone' => $tenant->emergency_contact_phone])</strong></div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-4 mb-3"><p class="mb-1 text-muted">Spouse Contact No</p><strong>@include('admin.partials.phone_links', ['phone' => $tenant->spouse_contact_number])</strong></div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-4 mb-3"><p class="mb-1 text-muted">Owner Phone</p><strong>@include('admin.partials.phone_links', ['phone' => $tenant->prev_owner_phone])</strong></div>
                        ...
                        <table class="table table-bordered table-sm text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>@include('admin.partials.phone_links', ['phone' => $mem['phone'] ?? null])</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
                        ...
                        <table class="table table-bordered table-sm text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $help['name'] ?? 'N/A' }}</td>
                                    <td>{{ $help['nid'] ?? 'N/A' }}</td>
                                    <td>@include('admin.partials.phone_links', ['phone' => $help['mobile'] ?? null])</td>
                        ...
                        <table class="table table-bordered table-sm text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>@include('admin.partials.phone_links', ['phone' => $driver['mobile'] ?? null])</td>
