            ...
            <div class="breadcrumb__content">
                <div class="breadcrumb__content__left">
                    <div class="breadcrumb__title">
                        <h2 style="color:white !important;">Add Monthly Expense</h2>
    ...
    <div class="row">
        <div class="col-md-10 offset-md-1">
            <div class="bg-style p-4 mb-4">
                <form action="{{ route('admin.expenses.store', $building->id) }}" method="POST">
                    @csrf
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="month" name="expense_month" value="{{ old('expense_month', $suggestedMonth) }}" class="form-control @error('expense_month') is-invalid @enderror" required>
                            @error('expense_month')
                        ...
                        @foreach($expenseFields as $field => $label)
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="{{ $field }}" value="{{ old($field, 0) }}" class="form-control expense-field @error($field) is-invalid @enderror" step="0.01" min="0">
                                    @error($field)
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                    ...
                    <div class="row mb-4 mt-2">
                        <div class="col-md-6 offset-md-6">
                            ...
                            <input type="text" id="total_expense_display" class="form-control bg-light fw-bold fs-5 text-primary text-end" value="0.00" readonly>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        ...
                        <button type="submit" class="btn btn-blue">Save Expense</button>
                    </div>
                </form>
            </div>
        </div>
