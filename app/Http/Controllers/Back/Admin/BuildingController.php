...
class BuildingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'holding_tax_document' => 'nullable|file|mimes:pdf,jpg,png,zip|max:5120',
            'dolil_document' => 'nullable|file|mimes:pdf,jpg,png,zip|max:5120',
            'noksha_document' => 'nullable|file|mimes:pdf,jpg,png,zip|max:5120',
            'mutation_document' => 'nullable|file|mimes:pdf,jpg,png,zip|max:5120',
            'khajna_document' => 'nullable|file|mimes:pdf,jpg,png,zip|max:5120',
            ...
            'sec_nid_document' => 'nullable|array',
            'sec_nid_document.*' => 'nullable|file|mimes:pdf,jpg,png|max:2048',
            'sec_birth_cert_number' => 'nullable|array',
            'sec_birth_cert_number.*' => 'nullable|string|max:50',
            'sec_birth_cert_document' => 'nullable|array',
            'sec_birth_cert_document.*' => 'nullable|file|mimes:pdf,jpg,png|max:2048',
            'sec_contact' => 'nullable|array',
            'sec_contact.*' => 'required|string|max:20',
            'sec_image' => 'nullable|array',
            'sec_image.*' => 'nullable|image|mimes:jpeg,png,jpg|max:2048',
        ]);
